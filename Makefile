...
clean:
	rm -rf cmd/gblobs/gblobs demo/tmp_gblobs_* demo/tmp_cli_gblobs_store demo/tmp_gblobs_encstore demo/tmp_gblobs_dedup demo/demo_file.txt tmp_* demo_file.txt

help:
	@echo "Targets:"
	@echo "  build      Build the CLI binary ($(BIN))"
	@echo "  test       Run all tests (go test ./...)"
	@echo "  demo       Run Go and CLI demos in ./demo/"
